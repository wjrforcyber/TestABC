...
TEST(GiaSamples, FormChoicesWith3Samples) {
    ...
    pGia0 = Gia_AigerRead( fileName, 0, 0, 0 );
    char fileName1[200];
    strcpy(fileName1, ASSETS_DIR);
    strcat(fileName1, "data/i10Samples/i10_SpId_1.aig");
    pGia1 = Gia_AigerRead( fileName1, 0, 0, 0 );
    char fileName2[200];
    strcpy(fileName2, ASSETS_DIR);
    strcat(fileName2, "data/i10Samples/i10_SpId_2.aig");
    pGia2 = Gia_AigerRead( fileName2, 0, 0, 0 );
